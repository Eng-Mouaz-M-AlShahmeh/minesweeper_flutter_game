...
import 'package:minesweeper_flutter_game/board_square.dart';
...
class GameActivityState extends State<GameActivity> {
  ...
  Image? getImage(ImageType type) {
    switch (type) {
      case ImageType.zero:
        return Image.asset('lib/images/0.png');
      case ImageType.one:
      ...
      case ImageType.bomb:
        return Image.asset('lib/images/bomb.png');
      case ImageType.facingDown:
        return Image.asset('lib/images/facingDown.png');
      case ImageType.flagged:
        return Image.asset('lib/images/flagged.png');
      default:
        return null;
    }
  }
